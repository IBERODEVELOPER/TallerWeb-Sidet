...
public interface AttendWorkService {
	...
	// fintarding 
	Page<AttendWork> findTardinessByEmployee(EntityEmployee employee, Pageable pageable);
    ...
    List<AttendWork> findTardinessByEmployeeAndMonth(EntityEmployee employee,int month);
