...
import com.ibero.demo.repository.AttendWorkDao;
...
public class AttendWorkServiceImpl implements AttendWorkService{
	...
	@Override
	@Transactional
	public void savetarding(EntityEmployee employee, DaysWeek diaEnum, LocalTime horaEntrada, LocalTime horaActual) {
	...
	public boolean existsByEmployeeAndDate(EntityEmployee employee, LocalDate date) {
	...
	@Override
	@Transactional(readOnly = true)
	public Page<AttendWork> findTardinessByEmployee(EntityEmployee employee, Pageable pageable) {
	    return rectardao.findByEmployee(employee, pageable);
	}

	@Override
	@Transactional(readOnly = true)
	public List<AttendWork> findByEmployee(EntityEmployee employee) {
		return rectardao.findByEmployee(employee);
	}

	@Override
	@Transactional(readOnly = true)
	public Page<AttendWork> findTardinessByEmployeeAndMonth(EntityEmployee employee, int month, Pageable pageable) {
		return rectardao.findByEmployeeAndMonth(employee, month, pageable);
	}

	@Override
	@Transactional(readOnly = true)
	public List<AttendWork> findTardinessByEmployeeAndMonth(EntityEmployee employee, int month) {
	...
	@Override
	public Optional<AttendWork> findByEmployeeAndDate(EntityEmployee employee, LocalDate date) {
